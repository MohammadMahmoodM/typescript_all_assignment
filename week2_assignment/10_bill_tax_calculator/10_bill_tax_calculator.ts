...
function bill_calulator(bill_amount: number ,no_of_unit: number): void{
    if (no_of_unit >= 100 && no_of_unit <= 200){
        ...
        console.log(`Your Payable amount was ${bill_amount}, Now after discount ${bill_amount-discount}`);
